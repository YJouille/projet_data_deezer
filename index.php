...
<body>
      ...
      <div id="nav-left">
        ...
        <div class="btn-logo-appli">
          <div class="logo-appli">
            ...
            <div class="line-sound-2"></div>
            <div class="line-sound-3"></div>
            <div class="line-sound-4"></div>
            <div class="line-sound-5"></div>
            <div class="line-sound-6"></div>
            <div class="line-sound-7"></div>
          </div>
        </div>
        <div id="nav-title">
    ...
    <div id="header-main">
      <div id="container-title">
        ...
        <p>Votre musique sans pub, partout. Seulement 9,99 €/mois ensuite.<br> Soumis à conditions. Des podcasts
          exclusifs.<br> Des playlists sur-mesure. Faites des découvertes.<br> Zappez à volonté. Plus de 50 M de
          chansons.<br> Annulation à tout moment.
        </p>
        <div>
          <button class="blue-button">commencer l'écoute</button>
          <button class="blue-button">s'abonner</button>
        </div>
      </div>
    </div>
  </header>
  ...
  <footer>
    <div class="footer-col">
      ...
      <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sit consequuntur eligendi iusto libero delectus nisi,
        ratione neque, vel expedita illum tenetur atque porro in sunt autem vitae, excepturi eveniet obcaecati!
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ad, magni non quo incidunt commodi nostrum, eum
        architecto eligendi ratione nesciunt excepturi, illum labore impedit saepe suscipit voluptas aut delectus
        facere.
    </div>
    <div class="footer-col">
    ...
    <div class="footer-col">
      ...
      <div class="flex-row-none">
        ...
        <div>
          ...
          <p class="clickable-line">03 89 87 85 86</p>
        </div>
      </div>
      <div class="flex-row-none margin-bot">
        ...
        <div>
          <p>Par email au :</p>
          <p class="clickable-line">contact[@]musicband.com</p>
        </div>
      </div>
    </div>
  </footer>
  ...
  <script>
    ...
    DZ.init({
      appId: '505602',
      channelUrl: 'https://www.alainmerucci.fr/musicband/channel.php',
      player: {
                //container: 'lecteur',
                // width: 800,
                // height: 100,
